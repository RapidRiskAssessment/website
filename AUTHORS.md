- gdestuynder@ - Original framework design (v1,2,3), parsers, integration, documentation, training, etc. See also https://github.com/gdestuynder/rra2json https://github.com/gdestuynder/rra3json for previous parsers.
