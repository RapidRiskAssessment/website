...
- Some other frameworks, which attempt to address specific issues with assessing risk accurately (e.g [FAIR](https://infogalactic.com/info/Factor_analysis_of_information_risk)), though these tend to focus on making all aspects of risk quantifiable (usually through assigning a somewhat precise dollar amount, or a fixed number from 0 to 100).
